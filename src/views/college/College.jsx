    ...
    <>
            ...
            <div className='max-h-96 overflow-auto'>
              {Array(20).fill().map((_, i) => (
                <div className='flex space-x-2 m-2'>
                  <input type="checkbox" />
                  <p className='truncate'>IIM Indian institute of Managementhjjhhghg</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <div>
        <div className='m-4 md:mx-12'>
          ...
          {/* Heading */}
          <div className='text-center bg-white shadow-sm rounded-md p-10 mb-8 space-y-3'>
            <h1 className='font-bold text-gray-700 text-4xl'>Colleges in India</h1>
            <p className='font-bold text-gray-600'>List of Colleges 1000</p>
          </div>
          ...
          {/* For Desktop left and right div*/}
          <div className='md:flex justify-around'>
            ...
            <div className='hidden md:flex flex-col'>
              ...
              <Filter title={'Institute Type'} checkTitle={'Govt'} />
